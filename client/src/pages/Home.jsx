      ...
      <motion.div initial={{ y: -40, opacity: 0 }}
        ...
        text-sm'>
          ...
          hover:bg-white/5 transition'>
                      ...
                      <button  onClick={() => {navigate('/dashboard'); setOpenProfile(false);}}
                      className='w-full px-4 py-3 text-sm text-left border-b border-white/10 hover:bg-white/5 transition'>Dashboard</button>
